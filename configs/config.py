...
parser = argparse.ArgumentParser(description="hyper-parameter for MultiP-R2Gen")
# ========================= Dataset Configs ==========================
...
parser.add_argument('--task', default='report', type=str)
...
parser.add_argument('--precision', type=str, default='16-mixed', help='16-mixed for float16; bf16-mixed for bfloat16 or 32, using for original pytorch amp auto cast')
